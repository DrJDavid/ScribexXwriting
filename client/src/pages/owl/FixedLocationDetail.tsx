...
export default function FixedLocationDetail() {
  // Log to confirm component is being rendered
  console.log("FixedLocationDetail component is rendering");
  ...
  const handleSelectPrompt = (prompt: GeneratedPrompt) => {
    console.log("Received prompt in FixedLocationDetail:", prompt);

...
import SimpleLocationDetail from "@/pages/owl/SimpleLocationDetail";
...
import TeacherSubmissionsList from "@/pages/teacher/SubmissionsList";
            ...
            <div className="min-h-screen flex flex-col">
              ...
              <main className="flex-1 pb-4">
                <Switch>
                  ...
                  />
                  <RoleBasedRoute 
                    path="/teacher/student/:studentId/submissions" 
                    component={TeacherSubmissionsList} 
                    allowedRoles={['teacher']} 
                  />
                  <RoleBasedRoute 
                  ...
                  />
                  <RoleBasedRoute 
                    path="/parent/child/:childId/submissions" 
                    component={ParentSubmissionsList} 
                    allowedRoles={['parent']} 
                  />
                  <RoleBasedRoute 
                  ...
                  <RoleBasedRoute 
                    ...
                    component={SimpleLocationDetail} 
                    allowedRoles={['student', 'teacher', 'parent']} 
                  />
                  <RoleBasedRoute 
                    path="/owl" 
